        ...
        return (
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-md">
              Upgrade to Pro to access automated document analysis, risk flagging, and GDPR insights powered by our isolated AI.
            </p>
            <Button size="lg" className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white text-lg px-8 py-3" asChild>
              <Link to="/billing">Upgrade to Pro</Link>
            </Button>
            <p className="text-sm text-muted-foreground mt-4">Your privacy is paramount. Our AI operates in an isolated environment.</p>
          </motion.div>
        );
      }
        ...
        <div className="space-y-6">
          ...
          >
            <Card className="bg-card/70 dark:bg-slate-800/70 backdrop-blur-sm border-border/50 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center text-xl"><FileSearch className="mr-2 h-6 w-6 text-sky-500"/>Analyze Document</CardTitle>
                <CardDescription>Select a document to begin AI analysis. Ensure it's a PDF.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  {/* Placeholder for document selection */}
