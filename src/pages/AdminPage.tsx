...
type UserContext = { user?: { role?: string } };
...
const AdminPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div variants={itemVariants} initial="hidden" animate="visible" className="grid md:grid-cols-3 gap-6">
        ...
        <Card className="bg-card/70 dark:bg-slate-800/70 backdrop-blur-sm border-border/50 shadow-md">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-green-500">
              {users.reduce((sum, u) => sum + u.docCount, 0)}
            </div>
          </CardContent>
        </Card>
      </motion.div>
                ...
                <motion.tbody variants={containerVariants} initial="hidden" animate="visible">
                  {filteredUsers.map((u) => (
                    <motion.tr
                      ...
                      className="border-b border-border/50 hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors"
                    >
                      ...
                      <td className="p-2">
                        <Button variant="ghost" size="sm" className="text-red-500 hover:bg-red-100 dark:hover:bg-red-700/50">
                          Deactivate
                        </Button>
                      </td>
                    </motion.tr>
